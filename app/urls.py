...
ORDER_LIST = { 'model': Order, 'template_name': "order_list.html", 
        'search_fields': [
            'id',
            'clients__person__last_name', 
            'clients__person__first_name',
            'clients__person__middle_name',
            'clients__org__title',
            ],
...
INVOICE_LIST = { 'model': Invoice, 'template_name': "invoice_list.html", 
        'search_fields': [
            'id',
            'order__clients__person__last_name', 
            'order__clients__person__first_name',
            'order__clients__person__middle_name',
            'order__clients__org__title',
            ],
